...
const Rules = ({ id = "rules" }) => {
  ...
  const rulesList = [
    ...
    "Internet access will be provided during the event.",
    "Any form of plagiarism or use of AI-generated code is strictly prohibited.",
    "Decisions made by the judges will be final and binding.",
    "Maintain decorum and follow all instructions from coordinators.",
