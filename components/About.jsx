  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center mb-16">
        ...
        >
          <span className="text-[#e99b63] font-semibold">CODEX-BUILD</span> is
          the ultimate coding showdown organized by{" "}
          <span className="text-[#e99b63] font-semibold">ALFA Coding Club</span>{" "}
          under <span className="text-[#e99b63] font-semibold">Tech Samarooh</span>.
          It’s more than a competition — it’s a journey through creativity,
          logic, and innovation. Programmers, designers, and thinkers come
          together to build, collaborate, and inspire.
        </motion.p>
      </div>
